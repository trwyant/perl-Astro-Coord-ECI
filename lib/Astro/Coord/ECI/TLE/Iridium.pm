...
# on Sat Jun 16 17:15:30 2018 GMT
...
__PACKAGE__->status( add => 25040, iridium => '+', 'Iridium 41', '' );
...
__PACKAGE__->status( add => 25288, iridium => '+', 'Iridium 65', '' );
__PACKAGE__->status( add => 25289, iridium => 'S', 'Iridium 66', '' );
__PACKAGE__->status( add => 25290, iridium => 'S', 'Iridium 67', '' );
...
__PACKAGE__->status( add => 25346, iridium => 'S', 'Iridium 75', '' );
...
__PACKAGE__->status( add => 25468, iridium => 'S', 'Iridium 81', '' );
