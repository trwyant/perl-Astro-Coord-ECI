...
# on Thu Jun 21 13:01:02 2018 GMT
...
__PACKAGE__->status( add => 25040, iridium => 'S', 'Iridium 41', '' );
...
__PACKAGE__->status( add => 25290, iridium => '-', 'Iridium 67', 'Tumbling' );
