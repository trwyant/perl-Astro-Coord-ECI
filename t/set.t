...
eod
    ...
    print <<eod;
#
# Test $test - \$set->set_all (name => 'Nemo')
...
eod
	...
	print <<eod;
#
# Test $test - Effect of \$set->set_all ('Nemo') on member $inx
#    Expected: 'Nemo'
#         Got: '$got'
eod
